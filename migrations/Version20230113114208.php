 ...
 */
final class Version20230113114208 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, tel INT DEFAULT NULL, siret INT NOT NULL, head_office VARCHAR(255) NOT NULL, register VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contract (id INT AUTO_INCREMENT NOT NULL, streamer_id INT DEFAULT NULL, compagny_contract_id INT DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, price INT NOT NULL, format VARCHAR(255) NOT NULL, modalities VARCHAR(255) NOT NULL, INDEX IDX_E98F285925F432AD (streamer_id), INDEX IDX_E98F2859E3908D26 (compagny_contract_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contract_status (id INT AUTO_INCREMENT NOT NULL, contract_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_474080512576E0FD (contract_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE platform (id INT AUTO_INCREMENT NOT NULL, has_type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_3952D0CBA2BDE448 (has_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE proposal (id INT AUTO_INCREMENT NOT NULL, streamer_id INT DEFAULT NULL, company_id INT DEFAULT NULL, has_proposal_status_id INT DEFAULT NULL, format VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_BFE5947225F432AD (streamer_id), INDEX IDX_BFE59472979B1AD6 (company_id), INDEX IDX_BFE59472EB4EA67B (has_proposal_status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE representative (id INT AUTO_INCREMENT NOT NULL, has_representative_id INT DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, INDEX IDX_2507390EC1A5C1BB (has_representative_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE streamer (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, followers INT NOT NULL, mail VARCHAR(255) DEFAULT NULL, siret INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
